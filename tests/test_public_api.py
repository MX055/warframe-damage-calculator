...
class PublicApiTests(unittest.TestCase):
    ...
    def test_runtime_is_explicit_loader_defaults_and_set_merges(self):
        ...
        galatine = arsenal.get("Galatine Prime")
        self.assertEqual(galatine.data.combo.max_combo, 12)
        self.assertEqual(galatine.data.combo.combo_interval, 20)
        self.assertEqual(galatine.data.runtime.combo, galatine.data.combo.max_combo)
